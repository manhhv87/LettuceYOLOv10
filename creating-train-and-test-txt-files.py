...
full_path_to_images = '/content/LettuceYOLOv10/custom_dataset/images'
...
with open('/content/LettuceYOLOv10/custom_dataset/train.txt', 'w') as train_txt:
...
with open('/content/LettuceYOLOv10/custom_dataset/val.txt', 'w') as val_txt:
    # Going through all elements of the list
    for e in p_val:
        # Writing current path at the end of the file
        val_txt.write(e)
